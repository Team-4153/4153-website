    ...
    <div className="py-12 w-full">
      ...
      <div className="w-full bottom-2 flex flex-col gap-4 justify-center items-center py-6">
        <div className="flex h-60 gap-4 w-[80%] flex-row">
          <div className="bg-blue-400 rounded-2xl basis-1/4 h-full object-cover justify-center align-middle flex">
            <img className='align-middle items-center object-contain' src="/N3B.png"/>
          </div>
          <div className="bg-blue-400 rounded-2xl basis-1/3 h-full object-cover justify-center align-middle flex">
        ...
        <div className="flex h-60 gap-4 w-[80%] flex-row-reverse">
        <div className="bg-blue-400 rounded-2xl basis-[44.44444444%] h-full object-cover justify-center align-middle flex">
